...
You can find a discussion about the tests along with a data table for 30 test trials in my blog post <em>Designing Wordle: Wordle Clone DSA, Part II: Data Implementation</em>, section Rerendering the Board Component, Method II: Using Stateless Variables plus a Switch State Variable. 
